...
## Current Promotional Text (Launch)
**Character count: 169**

```
🚀 NEW: AI photo estimates in seconds! Get instant pricing & same-day pickup. Spring cleaning special: $25 off your first haul. Download now & declutter today!
```
...
**Character count: 170**
```
☀️ Summer cleanout? AI estimates in seconds! Same-day pickup available. $25 off first-time hauls. Clear the garage, patio & more. Download now & declutter fast!
```
...
## Promotional Hooks (Alternative Angles)
...
1. **Update frequency**: Every 2-4 weeks to stay fresh in App Store
2. **A/B test**: Rotate between value, speed, and seasonal hooks
3. **Emojis**: Use 1-2 relevant emojis for visual appeal
4. **CTA**: Always include "Download now" or similar action
5. **Urgency**: Time-sensitive offers perform better ("Today," "Now," "$25 off")
6. **Character sweet spot**: 150-170 (use the space!)
