...
const introTemplates = {
    ...
    'mattress-disposal': [
        ...
        (city) => `Need a mattress removed in ${city.name}? Umuve serves all of ${city.county} County with fast, eco-friendly mattress disposal. Whether it's a king, queen, twin, or memory foam — we'll haul it out of any room, navigate stairs and tight spaces, and recycle the materials responsibly. Starting at just $119.`,
        ...
        (city) => `${city.name} residents near ${city.landmarks ? city.landmarks[0] : city.neighborhoods[0]} — Umuve handles mattress disposal the right way. Florida law requires proper mattress recycling, and we're fully compliant. Same-day pickup from $119. We serve all of ${city.name} including ${city.neighborhoods.slice(0, 2).join(' and ')}, with an average response time of just ${city.avgResponseMinutes} minutes.`,
    ...
    'appliance-removal': [
        ...
        (city) => `${city.name} homeowners choose Umuve for appliance removal because we handle the entire process — from disconnecting your old washer, dryer, or refrigerator to hauling it to certified recycling facilities. Serving all ${city.name} neighborhoods with same-day availability and upfront pricing from $119.`,
    ...
    'couch-removal': [
        ...
        (city) => `Ready to replace your couch in ${city.name}? Umuve makes old sofa removal simple. We handle sectionals, sleeper sofas, recliners, loveseats, and every type of seating furniture. Serving all ${city.name} neighborhoods including ${city.neighborhoods.slice(0, 3).join(', ')} with same-day pickup from $119.`,
        ...
        (city) => `${city.commonScenarios ? city.commonScenarios[0] + ' often means old couches need to go.' : 'Old couches pile up fast in South Florida.'} Umuve handles couch removal in ${city.name}, FL from start to finish — we carry, load, haul, and recycle or donate. Serving ${city.neighborhoods.slice(0, 2).join(', ')} and every ${city.name} neighborhood. From $119, same-day service.`
    ],
    'refrigerator-disposal': [
        ...
        (city) => `Improper refrigerator disposal in ${city.county} County can result in fines up to $37,500 per day per violation. That's not a typo. Umuve ensures full EPA compliance for every fridge we remove in ${city.name} — Freon recovery, materials recycling, and proper documentation. Serving all ${city.name} neighborhoods from $119.`,
    ...
    'tv-recycling': [
        ...
        (city) => `TV recycling in ${city.name} doesn't have to be complicated. Umuve picks up, transports, and recycles — 97% of materials recovered at R2-certified facilities. We accept CRTs (yes, even the massive old tube TVs), flat screens, monitors, and projection TVs. ${city.operators} operators serving all of ${city.county} County from $119.`
    ],
    'construction-debris': [
...
const pricingByService = {
    'furniture-removal': [
        { label: 'Single Piece', desc: 'One couch, dresser, table, etc.', price: '$119' },
    ...
    'mattress-disposal': [
        { label: 'Single Mattress', desc: 'Twin, full, or queen mattress', price: '$119' },
    ...
    'appliance-removal': [
        { label: 'Single Appliance', desc: 'Washer, dryer, dishwasher, etc.', price: '$119' },
    ...
    'electronics-recycling': [
        { label: 'Small Load', desc: 'Few devices, cables, accessories', price: '$119' },
    ...
    'couch-removal': [
        { label: 'Single Couch', desc: 'Standard sofa or loveseat', price: '$119' },
    ...
    'refrigerator-disposal': [
        { label: 'Mini Fridge', desc: 'Compact or dorm fridge', price: '$119' },
    ...
    'tv-recycling': [
        { label: 'Single TV', desc: 'One flat screen or CRT', price: '$119' },
    ...
    'yard-waste-removal': [
        { label: 'Small Pile', desc: 'Few bags or small brush pile', price: '$119' },
...
function getServiceCityFAQs(service, city) {
    ...
    const baseFAQs = {
        'furniture-removal': [
            { q: `How much does furniture removal cost in ${city.name}, FL?`, a: `Furniture removal in ${city.name} starts at $119 for a single piece. A full living room set averages $249. Pricing depends on the number of items, size, and accessibility. Get an instant quote online — no phone call needed. ${localTipText}` },
        ...
        'mattress-disposal': [
            { q: `How much does mattress disposal cost in ${city.name}?`, a: `Mattress disposal in ${city.name} starts at $119 for a single mattress. A mattress and box spring set is typically $119. King sets run $139. All prices include pickup from any room and eco-friendly recycling.` },
        ...
        'appliance-removal': [
            { q: `How much does appliance removal cost in ${city.name}?`, a: `Appliance removal in ${city.name} starts at $119 for a single appliance. A washer/dryer pair is typically $139. Full kitchen appliance removal averages $299. All prices include disconnection and eco-friendly disposal.` },
        ...
        'electronics-recycling': [
            { q: `How much does electronics recycling cost in ${city.name}?`, a: `Electronics recycling in ${city.name} starts at $119 for a small load. A standard computer, monitor, and printer combo is typically $119. Office IT cleanouts start at $199. All items go to R2-certified recyclers serving ${city.county} County.` },
        ...
        'couch-removal': [
            { q: `How much does couch removal cost in ${city.name}?`, a: `Couch removal in ${city.name} starts at $119 for a standard sofa or loveseat. Sectionals average $139. A full living room set runs $219. All prices include labor, loading, hauling, and disposal — no hidden fees.` },
        ...
        'refrigerator-disposal': [
            { q: `How much does refrigerator disposal cost in ${city.name}?`, a: `Refrigerator disposal in ${city.name} starts at $119 for a mini fridge. Standard refrigerators are $119-$149 depending on size. French door and commercial units run up to $249. All prices include disconnection and EPA-compliant recycling.` },
        ...
        'tv-recycling': [
            { q: `How much does TV recycling cost in ${city.name}?`, a: `TV recycling in ${city.name} starts at $119 for a single TV. Multiple TVs and monitors are $119. A full home theater system (TV + equipment) is typically $149. All items go to R2-certified e-waste facilities serving ${city.county} County.` },
        ...
        'yard-waste-removal': [
            { q: `How much does yard waste removal cost in ${city.name}?`, a: `Yard waste removal in ${city.name} starts at $119 for a small pile. Post-landscaping cleanup averages $149. Large loads (tree trimming, storm cleanup) run $249-$499. All green waste is composted or mulched — zero landfill.` },
