...
import { authApi, driverApi, ApiError } from "@/lib/api";
...
function SignupForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!truckType) {
      setError("Please select your truck type.");
      setLoading(false);
      return;
    }
    ...
    try {
      ...
      // Register as a driver with truck type and optional invite code
