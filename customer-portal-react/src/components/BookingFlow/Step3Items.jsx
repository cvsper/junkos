...
const ITEM_CATALOG = {
  furniture: {
    ...
    icon: '\uD83D\uDECB\uFE0F',
    items: [
      { id: 'sofa',                label: 'Sofa / Couch',                price: 89 },
      { id: 'sofa_sleeper',        label: 'Sleeper Sofa',                price: 109 },
      { id: 'sofa_sectional',      label: 'Sectional Sofa',              price: 139 },
      { id: 'chair_recliner',      label: 'Recliner',                    price: 79 },
      { id: 'chair_office',        label: 'Office Chair',                price: 69 },
      { id: 'dresser',             label: 'Dresser',                     price: 79 },
  ...
  beds: {
    ...
    icon: '\uD83D\uDECF\uFE0F',
    items: [
      { id: 'mattress',            label: 'Mattress (any size)',         price: 75 },
      { id: 'box_spring',          label: 'Box Spring',                  price: 75 },
  ...
  appliances: {
    ...
    icon: '\uD83D\uDD0C',
    items: [
      { id: 'refrigerator',        label: 'Refrigerator (Standard)',     price: 99 },
      { id: 'refrigerator_bar',    label: 'Mini Fridge / Bar Fridge',    price: 69 },
      { id: 'washer',              label: 'Washer',                      price: 79 },
      { id: 'dryer',               label: 'Dryer',                       price: 79 },
  ...
  outdoor: {
    ...
    items: [
      ...
      { id: 'hot_tub',             label: 'Hot Tub',                     price: 299 },
      { id: 'pool_table',          label: 'Pool Table',                  price: 199 },
      { id: 'piano',               label: 'Piano',                       price: 199 },
...
const TRUCK_LOAD_OPTIONS = [
  { id: 'min',  label: 'Minimum Load',   price: 99,  desc: 'A few small items' },
