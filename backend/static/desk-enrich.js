...
(function(){
  ...
  function el(tag, cls, text){ var e = document.createElement(tag); if(cls) e.className = cls; if(text != null) e.textContent = text; return e; }
    (function(){ if(document.querySelector('link[href^="/static/desk-enrich.css"]')) return; var l = document.createElement("link"); l.rel = "stylesheet"; l.href = "/static/desk-enrich.css?v=2"; document.head.appendChild(l); })();
