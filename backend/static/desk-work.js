...
(function(){
  ...
  function age(h){
    ...
    (function(){ if(document.querySelector('link[href^="/static/desk-work.css"]')) return; var l = document.createElement("link"); l.rel = "stylesheet"; l.href = "/static/desk-work.css?v=3"; document.head.appendChild(l); })();
