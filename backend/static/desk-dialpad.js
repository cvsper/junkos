...
(function(){
  ...
  function el(tag, cls, text){
    ...
    (function(){ if(document.querySelector('link[href^="/static/desk-dialpad.css"]')) return; var l = document.createElement("link"); l.rel = "stylesheet"; l.href = "/static/desk-dialpad.css?v=3"; document.head.appendChild(l); })();
